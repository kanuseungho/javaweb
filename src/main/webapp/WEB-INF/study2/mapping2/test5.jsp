...
<div class="container">
  ...
  <hr/>
 	...
 	<div>
  		<form name="myform" method="post" action="${ctp}/Test5_5.mi">
  			<div>
  				첫번 째 수 : <input type="number" name="su1" value="1" class="form-control"/>
  			</div>
  			<div>연산자:
  			...
  			<div>
  				두번 째 수 : <input type="number" name="su2" value="1" class="form-control"/>
  			</div>
  			<div>
  ...
  <hr/>		
	<div>
		...
		<input type="button" value="구구단 출력(5_3에 출력)" onclick="guguDan()" class="btn btn-secondary"/>
	</div>
</div>
<p><br/></p>
